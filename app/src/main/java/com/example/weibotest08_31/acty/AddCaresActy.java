 ...
 */
public class AddCaresActy extends BaseActy{
...
//                    List<Weibo> weiboList = (List<Weibo>) backList.get(0).get("weiboitem");
                ...
                case GET_DETIAL_FAIL:
                    ...
                    break;
                case QUXIAO_OK:
                    MyToast.showToast(AddCaresActy.this,msg.obj+"");
                    break;
                case QUXIAO_FAIL:
                    MyToast.showToast(AddCaresActy.this,msg.obj+"");
                    break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        syncImgLoader = new SyncImgLoader(AddCaresActy.this);
...
//        titleBar.leftIV.setOnClickListener(this);
        ...
        commitBT=(Button)findViewById(R.id.au_bt_commit);
        commitBT.setOnClickListener(this);
        commitBT.setText("关注他");
        titleBar.leftIV.setOnClickListener(this);
        ...
        private void bindViews() {
            weiboAdapter = new WeiboAdapter(AddCaresActy.this);
        ...
        switch (v.getId()){
            case R.id.au_bt_commit:
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        String backStr2=dotNetManager.addCareSomeOne(getWeiboApp().getUser().getId()+"",
                                getIntent().getStringExtra("userId"));
                        try {
