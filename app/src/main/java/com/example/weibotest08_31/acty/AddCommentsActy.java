 ...
 */
public class AddCommentsActy extends BaseActy {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case LEAVEMSG_OK:
                    MyToast.showToast(AddCommentsActy.this,msg.obj.toString());
                    finish();
                    break;
                case LEAVEMSG_FAIL:
                    MyToast.showToast(AddCommentsActy.this,msg.obj.toString());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initTitleBar(R.id.al_tb_title, null, null, "评论");
            ...
            case R.id.al_bt_commit:
                new Thread(new Runnable() {
                    ...
                    public void run() {
                       ...
                       String backStr=dotNetManager.commentWeibo(getWeiboApp().getUser().getId()+"",getIntent().getStringExtra("weiboId"),leavemsg.getText().toString());
                        try {
